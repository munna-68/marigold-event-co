...
export default function RentalDetail() {
  ...
  const handleAdd = () => { if (!date || !available) return; addToQuote(item, date, quantity); setAdded(true); };
